...
require("dotenv").config(); //dotenv was also used in ./index.js
...
function generateGetUrl(Key) {
  return new Promise((resolve, reject) => {
    const params = {
      Bucket,
      Key, //The key parameter refers to the name of the remote file that is going to be retrieved, or the name the file is going to be saved in the bucket.
